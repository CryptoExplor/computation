...
import { db } from "../config/firebaseConfig"; // Assuming db is exported from this path
import {
  collection,
  getDocs,
  doc,
...
export default function AdminDashboard() {
  ...
  const loadUsers = async () => {
    try {
      // Corrected Firestore path to include artifacts/{appId}
      const userSnap = await getDocs(collection(db, `artifacts/${appId}/users`));
